...
epsilonSum1D: epsilonSum1D.cpp runSim1D.o runSim1D.h resultFinder.h resultFinder.o levelSpacings.o levelSpacings.h metric.h metric.o avgEigVec.o avgEigVec.h
	g++ epsilonSum1D.cpp runSim1D.o resultFinder.o levelSpacings.o avgEigVec.o metric.o -o epsilonSum1D -O2 -larmadillo -std=c++14
...
AvgEigVec.o: avgEigVec.cpp avgEigVec.h metric.o metric.h
	g++ -c avgEigVec.cpp metric.o metric.h -O2 -larmadillo -std=c++14
